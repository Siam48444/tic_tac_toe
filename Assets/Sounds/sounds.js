...
export const click_sound_X = new Audio("./click_sound_X.mp3");
export const click_sound_O = new Audio("./click_sound_O.mp3");
export const winning_sound = new Audio("./winning_sound.mp3");
export const draw_sound = new Audio("./draw_sound.mp3");
export const jumpscare_sound = new Audio("./jumpscare_sound.mp3");
